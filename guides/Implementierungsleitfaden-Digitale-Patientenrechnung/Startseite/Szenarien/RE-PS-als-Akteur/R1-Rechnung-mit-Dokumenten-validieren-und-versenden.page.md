...
Weitere Details zur Signatur, siehe [gemSpec_eRg_FD - Abschnitt 6.5 Signatur](https://gemspec.gematik.de/docs/gemF/gemF_DiPag/latest/gemSpec_DiPag_FD_V1.0.0/#6.5).
