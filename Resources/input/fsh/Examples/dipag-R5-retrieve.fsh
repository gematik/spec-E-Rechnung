...
* extension[rechnungsdatum].url = "https://gematik.de/fhir/erg/StructureDefinition/dipag-documentreference-rechnungsdatum"
* extension[rechnungsdatum].valueDateTime = "2023-09-28T13:00:00.123+02:00"
* extension[zahlungszieldatum].url = "https://gematik.de/fhir/erg/StructureDefinition/dipag-documentreference-zahlungszieldatum"
* extension[zahlungszieldatum].valueDateTime = "2023-10-28T13:00:00.123+02:00"
* extension[gesamtbetrag].url = "https://gematik.de/fhir/erg/StructureDefinition/dipag-documentreference-gesamtbetrag"
* extension[gesamtbetrag].valueMoney
  * value = 16.20
  * currency = #EUR
* meta.tag[0] = https://gematik.de/fhir/erg/CodeSystem/dipag-rechnungsstatus-cs#offen
...
* content[rechnungspdf].format = https://gematik.de/fhir/erg/CodeSystem/dipag-attachment-format-cs#dipag
...
* content[angereicherteRechnung].format = https://gematik.de/fhir/erg/CodeSystem/dipag-attachment-format-cs#angereichertesPDF
...
* content[strukturierterRechnungsinhalt].format = https://gematik.de/fhir/erg/CodeSystem/dipag-attachment-format-cs#rechnungsinhalt
...
* content[anhang].format = https://gematik.de/fhir/erg/CodeSystem/dipag-attachment-format-cs#rechnungsanhang
